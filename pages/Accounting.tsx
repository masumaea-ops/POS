  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 pb-16 overflow-y-auto">
      <PageHeader 
        ...
        primaryAction={{ label: "Register Ledger Account", onClick: () => setShowAddAccountModal(true) }}
      />
      ...
      {/* CORE NAVIGATION SELECTION TABS */}
      <div className="px-4 md:px-8 mt-6">
        <div className="flex border-b border-slate-150 dark:border-slate-800 gap-1 overflow-x-auto">
          <button 
             onClick={() => setActiveTab('overview')}
             className={`px-4 py-2.5 text-xs font-extrabold tracking-wide uppercase border-b-2 transition-all ${
               activeTab === 'overview' 
          ...
          >
             💰 Auto Bank Settlement Reconciliation
          </button>
          <button 
      ...
      <div className="p-4 md:px-8 mt-5">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-fade-in">
              ...
              <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 lg:col-span-8 space-y-6">
                 ...
                 <div className="p-4 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/60 rounded-xl text-xs space-y-2">
                    <h4 className="font-black text-emerald-800 dark:text-emerald-400">✅ Dynamic Audit Integrity Verified</h4>
              ...
              <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 lg:col-span-4 flex flex-col justify-between">
                 ...
                 <div className="pt-4 mt-6 border-t border-slate-100 dark:border-slate-700 text-center">
                    <button 
                       ...
                       className="py-2.5 px-4 bg-slate-105 hover:bg-slate-200 dark:bg-slate-700 border text-xs font-black uppercase tracking-wider block w-full rounded-xl"
                    >
                       🖨️ Produce Auditor Tax Reports
                    </button>
                 </div>
              </div>
           </div>
                 ...
                 <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-150 dark:divide-slate-700">
                       {filteredAccounts.map(acc => (
                          ...
                          >
                             <td className="p-3 font-bold text-brand-orange font-semibold">🔑 {acc.id}</td>
         ...
         {activeTab === 'journal' && (
           <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 animate-fade-in text-xs">
              <div>
                 <h3 className="text-base font-black text-slate-900 dark:text-white">✍️ Post General Ledger Adjustment Voucher</h3>
           ...
           <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-705 animate-fade-in text-xs space-y-5">
              ...
              <div className="border rounded-xl p-4 bg-slate-50 dark:bg-slate-900 font-mono space-y-2">
                 ...
                 <div className="space-y-1 text-slate-700 dark:text-slate-350">
                    <p className="flex items-center gap-1.5">✔️ Auto calculation of 16% tax inclusion on parts checkouts.</p>
                    <p className="flex items-center gap-1.5">✔️ Generate unique SHA eTIMS compliant hexadecimal serial signatures.</p>
                    <p className="flex items-center gap-1.5">✔️ POS split payments and credit invoice dunning automated.</p>
                    <p className="flex items-center gap-1.5">✔️ Supplier B2B procurement PO tax matches input claims registry.</p>
                 </div>
              </div>
           </div>
         )}
